...
const ImageCard = ({ src, alt }) => {
  return (
    <div className="h-[450px] w-[40px] lg:w-[60px] lg:rounded-2xl rounded-md hover:w-[50vw] transition-all ease-linear transform duration-400">
      <img
        src={src}
        alt={alt}
        className="h-[450px] lg:rounded-2xl rounded-md  hover:w-[50vw] object-cover overflow-hidden transition-all ease-linear transform duration-400"
      />
    </div>
  );
};
